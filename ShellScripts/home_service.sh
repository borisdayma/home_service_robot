...
sleep 5
xterm  -e  " source $DIR/catkin_ws/devel/setup.bash; rosrun rviz rviz -d $DIR/catkin_ws/src/home_service_robot/rviz/config.rviz" &
sleep 5
xterm  -e  " source $DIR/catkin_ws/devel/setup.bash; rosrun add_markers add_markers_node" &
sleep 5
xterm  -e  " source $DIR/catkin_ws/devel/setup.bash; rosrun pick_objects pick_objects_node" &